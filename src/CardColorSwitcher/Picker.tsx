...
const snapPoints = colors.map((_, i) => {
  return (i * MARGIN_RIGHT + i * CIRCLE_CONTAINER_WIDTH + 20
  + CIRCLE_CONTAINER_WIDTH / 2) - BORDER_SIZE / 2;
});

export default function Picker({ disabled, handlePress }:PickerProps) {
